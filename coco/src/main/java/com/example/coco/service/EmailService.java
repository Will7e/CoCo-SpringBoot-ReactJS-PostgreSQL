...
public class EmailService implements EmailSender {
    ...
    public void sendEmail(String to, String email) {
        try{
            ...
            helper.setFrom("Coder.Connect.Chanel@gmail.com");
    ...
    public String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hej " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> " +
                "Welcome to CoCo. Please click on the below link to activate your account: " +
